...
public enum Msgs {
    ...
    INFO_FACTION("faction.info.faction", "&7<faction>"), INFO_FOUNDER("faction.info.founder", "&aKurucu: &r<player>"),
    INFO_ADMINS("faction.info.admins", "&aYetkililer: &r<players>"),
    INFO_PLAYERS("faction.info.players", "&aDiğer Üyeler: &r<players>"),
    INFO_LEVEL("faction.info.level", "&aSeviye: &r<amount>"), INFO_EXP("faction.info.exp", "&aDeneyim: &r<amount>"),
    INFO_PRESTIGE("faction.info.prestige", "&aPrestij: &r<amount>"),
    INFO_BANK("faction.info.bank", "&aBanka: &r<amount>"),
    ...
    CANT_LEAVE_FACTION_OWNER("faction.owner_cant_leave", "&4Kurucusu olduğun klandan ayrılamazsın!!%%"
            + "&cKlanını devretmek için:&r /klan kurucuyap <isim>"),
